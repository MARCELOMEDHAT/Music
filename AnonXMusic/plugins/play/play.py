    ...
    [
        [
            InlineKeyboardButton(
                text="اشترك هنا", url="https://t.me/VeGaSource"
            ),                        
        ],        
    ]
)
...
async def play_commnd(
    ...
    x = await check_is_joined(message)
    if not x:
      return
