...
@app.on_message(filters.command("auth") & filters.group & ~BANNED_USERS, group=3312)

@app.on_message(filters.command(["مصرح له"],"") & filters.group & ~BANNED_USERS, group=3313)
@AdminActual
...
@app.on_message(filters.command("unauth") & filters.group & ~BANNED_USERS, group=700112)

@app.on_message(filters.command(["غير مصرح له"],"") & filters.group & ~BANNED_USERS, group=5515113)
@AdminActual
...
@app.on_message(
    filters.command(["authlist", "authusers"]) & filters.group & ~BANNED_USERS, group=60011)

@app.on_message(filters.command(["المصرح لهم"],"") & filters.group & ~BANNED_USERS, group=991991)    
@language
