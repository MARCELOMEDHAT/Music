...
@app.on_message(filters.command(["skip", "cskip", "next", "cnext"]) & filters.group & ~BANNED_USERS, group=8887127)

@app.on_message(filters.command(["التالي","تخطي"],"") & ~BANNED_USERS, group=55155)
@AdminRightsCheck
